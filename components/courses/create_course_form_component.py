...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page):
        super().__init__(page)
        self.title_input = Input(page, 'create-course-form-title-input', 'Input title')
        self.estimated_time_input = Input(page, 'create-course-form-estimated-time-input', 'Input estimated time')
    ...
    @allure.step(
        'Check visible form create course "{title}", "{estimated_time}", "{description}", "{max_score}", "{min_score}"')
